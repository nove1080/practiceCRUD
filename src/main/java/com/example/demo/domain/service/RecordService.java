...
public class RecordService {
	...
	public Long save(RecordRequest record, UserEntity userEntity) {
		RecordEntity recordEntity = getRecordEntity(record, userEntity);
	...
	private RecordEntity getRecordEntity(RecordRequest record, UserEntity userEntity) {
